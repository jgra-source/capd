...
(function () {
  ...
  const BODY_RE =
    /\/api\/v1\/[^/]+\/(usage|balance|credits|subscription_details|paused_subscription_details|overage_spend_limit|overage_credit_grant|run-budget|consumer_pricing)\b/i;
